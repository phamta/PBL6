...
export class CreateVisaExtensionTables1693000000000 implements MigrationInterface {
  name = 'CreateVisaExtensionTables1693000000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Create visa_extension_documents table
    await queryRunner.query(`
      CREATE TABLE "visa_extension_documents" (
        "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
    ...
    // Create visa_extension_history table
    await queryRunner.query(`
      CREATE TABLE "visa_extension_history" (
        "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
    ...
    await queryRunner.query(`
      ...
      FOREIGN KEY ("applicant_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION
    `);
    ...
    await queryRunner.query(`
      ...
      FOREIGN KEY ("changed_by_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION
    `);

    // Create indexes for better performance
    await queryRunner.query(`CREATE INDEX "IDX_visa_extensions_status" ON "visa_extensions" ("status")`);
    await queryRunner.query(`CREATE INDEX "IDX_visa_extensions_applicant_id" ON "visa_extensions" ("applicant_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_visa_extensions_visa_expiry_date" ON "visa_extensions" ("visa_expiry_date")`);
    await queryRunner.query(`CREATE INDEX "IDX_visa_extensions_submission_date" ON "visa_extensions" ("submission_date")`);
    await queryRunner.query(`CREATE INDEX "IDX_visa_extension_documents_visa_extension_id" ON "visa_extension_documents" ("visa_extension_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_visa_extension_history_visa_extension_id" ON "visa_extension_history" ("visa_extension_id")`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop tables in reverse order
    await queryRunner.query(`DROP TABLE "visa_extension_history"`);
    await queryRunner.query(`DROP TABLE "visa_extension_documents"`);
    await queryRunner.query(`DROP TABLE "visa_extensions"`);

    // Drop enum types
    await queryRunner.query(`DROP TYPE "document_type_enum"`);
    await queryRunner.query(`DROP TYPE "study_program_enum"`);
    await queryRunner.query(`DROP TYPE "visa_type_enum"`);
    await queryRunner.query(`DROP TYPE "visa_extension_status_enum"`);
  }
}
