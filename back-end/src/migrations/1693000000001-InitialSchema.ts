...
export class InitialSchema1693000000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TYPE IF NOT EXISTS "visa_extension_status_enum" AS ENUM(
    ...
    await queryRunner.query(`
      CREATE TYPE IF NOT EXISTS "visa_type_enum" AS ENUM(
        'tourist', 'business', 'student', 'work', 'diplomatic', 'transit'
      )
    `);

    await queryRunner.query(`
      CREATE TYPE IF NOT EXISTS "study_program_enum" AS ENUM(
