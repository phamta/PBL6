...
import { MOUApplication, MOUStatus } from '../user/entities/mou-application.entity';
import { VisitorApplication, VisitorStatus } from '../user/entities/visitor-application.entity';
import { TranslationRequest, TranslationStatus } from '../user/entities/translation-request.entity';
