...
export default function SpecialistLayout({
  ...
  useEffect(() => {
    if (userRole && userRole !== UserRole.SPECIALIST) {
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-lg">
          <div className="flex items-center justify-between p-4 border-b">
            <h2 className="text-lg font-semibold text-orange-700">⚡ Hệ thống xét duyệt</h2>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-64 lg:bg-white lg:shadow-sm lg:block">
        <div className="flex flex-col h-full">
          <div className="p-6 border-b bg-orange-50">
            <h2 className="text-xl font-bold text-orange-700">⚡ Hệ thống xét duyệt</h2>
            <p className="text-sm text-orange-600 mt-1">Review & Processing System</p>
          </div>
          ...
          <div className="p-4 border-t">
            <div className="mb-3 px-3 py-2 bg-orange-50 rounded-lg">
              <p className="text-xs text-orange-600 mb-1">Đăng nhập với vai trò:</p>
              <p className="text-sm font-medium text-orange-700">Chuyên viên xét duyệt</p>
            </div>
              ...
              <div className="relative" ref={userMenuRef}>
                ...
                >
                  ...
                  <span className="hidden sm:block text-sm font-medium">
                    {authHelpers.getUser()?.name || 'Chuyên viên'}
                  </span>
