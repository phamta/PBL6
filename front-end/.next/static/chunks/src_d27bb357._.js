...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            // Call real API
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].login(email, password);
            if (response.access_token && response.user) {
                var _response_user_roles_, _response_user_roles;
                // Store token and user info
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authHelpers"].setToken(response.access_token);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authHelpers"].setUser(response.user);
                // Get user role from response
                const userRole = response.user.role || ((_response_user_roles = response.user.roles) === null || _response_user_roles === void 0 ? void 0 : (_response_user_roles_ = _response_user_roles[0]) === null || _response_user_roles_ === void 0 ? void 0 : _response_user_roles_.name) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePermissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].USER;
...
//# sourceMappingURL=src_d27bb357._.js.map