...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authHelpers"].login({
                email,
                password
            });
            if (response.success && response.data) {
                // Get user role from response
                const userRole = response.data.user.role || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePermissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserRole"].USER;
...
//# sourceMappingURL=src_79222b28._.js.map