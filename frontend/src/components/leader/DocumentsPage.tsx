...
const documentsData = [
  {
    ...
    description:
      "Bilateral partnership agreement for student exchange and research collaboration.",
  },
  {
    id: "DOC-2025-002",
    ...
    description:
      "Memorandum of Understanding for engineering student exchange program.",
  },
  {
    id: "DOC-2025-003",
          ...
          {selectedDocument && (
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="col-span-2">
                            ...
                            <Input
                              className="mt-1"
                              defaultValue={selectedDocument.partner}
                            />
                          ...
                          <div>
                            ...
                            <Input
                              type="date"
                              className="mt-1"
                              defaultValue={selectedDocument.signedDate}
                            />
                          </div>
                          <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <Card className="p-4">
                          ...
                          <p className="text-sm text-muted-foreground mb-3">
                            Request revisions or provide comments to the
                ...
                <DialogFooter className="flex flex-row justify-end items-center gap-2 mt-4 border-t pt-4">
                  <Button
                    variant="ghost"
                    className="rounded-[10px] border border-[#E2E8F0] bg-[#F8F9FC] text-[#1E293B] px-4 h-9"
                  ...
                  <Button
                    variant="ghost"
                    className="rounded-[10px] border border-[#E2E8F0] bg-[#F8F9FC] text-[#EF4444] px-6 h-9 flex items-center gap-2"
                    onClick={handleReject}
                  >
                  ...
                  <Button
                    className="rounded-[10px] bg-[#00A63E] hover:bg-[#059142] text-white px-8 h-9 flex items-center gap-2"
                    onClick={handleApprove}
                  >
