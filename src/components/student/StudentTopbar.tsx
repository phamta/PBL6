...
export function StudentTopbar({
  ...
  return (
    <div className="h-16 bg-card border-b border-border flex items-center justify-between px-6 shadow-sm">
      ...
      <div className="flex items-center gap-4">
        <div>
          <h4 className="text-primary font-semibold">Cổng Sinh Viên</h4>
          <p className="text-sm text-muted-foreground">Đại học Bách Khoa - Đà Nẵng</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem className="py-3">
              <div className="flex flex-col gap-1">
                <p>Visa của bạn còn 15 ngày nữa sẽ hết hạn</p>
                <span className="text-muted-foreground">5 phút trước</span>
              </div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            <DropdownMenuLabel>Tài Khoản</DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuItem>Hồ Sơ Sinh Viên</DropdownMenuItem>
            <DropdownMenuItem>Đổi Mật Khẩu</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-destructive">
              <LogOut className="w-4 h-4 mr-2" />
